...
add for MOS: pushm, popm, xch				 3 Feb 2017
output symbol to object code file			14 Feb 2017  (valentine)
...
void main(int argc, char *argv[]){
	...
	char * fout = malloc(strlen(argv[1]) + 1 + margin);
	char * flis = malloc(strlen(argv[1]) + 1 + margin);
