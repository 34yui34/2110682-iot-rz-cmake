/* gencode.c
   code generator som-c		2 Jan 2004
	...
	print can handle "\n \t \\"				5 Nov 2016
	add readport, writeport, settimer0,
	  settimer1, ei, di, doze				21 Nov 2016
	integrate with IoT board				28 Jan 2017
*/
...
//  for writeport(num, a1, a2)
int gentrap3(int n, int e){	// e is arglist
	int d, a1, a2;
//	e = cdr(e);
	a1 = genex(arg2(e));	// first arg
	out1("push sp r%d\n",a1);
	freeR(a1);
	a2 = genex(arg3(e));	// second arg
	out1("push sp r%d\n",a2);
	freeR(a2);
	d = genex(car(e));		// port number
	out2("trap r%d #%d\n",d,n);
	freeR(d);
	return retvalR;
}
...
//	case tkLTLT:
	...
	case tkCALL:
		...
		case 5: d = gentrap(18,e); break;		// readport
		case 6: d = gentrap3(19,e); break;		// writeport
		case 7: d = gentrap(13,e); break;		// settimer0
		case 8: d = gentrap(14,e); break;		// settimer1
		case 9: d = gentrap(2,e); break;		// printc
		case 10: d = gentrap(3,e); break;		// prints
		case 11: d = gentrap(4,e); break;		// input
		case 12: d = gentrap(19,e); break;		// malloc
...
/*
		if(eqs(getName(idx),"asm")){
			...
			if( isString(e1) )
				out1("%s\n",&strbuf[cdr(e1)]);
		}else if(eqs(getName(idx), "readport")){
			d = gentrap(18,e);
//		...
		}else {
*/
